...
export function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      // Backend treats `name` as optional but rejects an empty string, so omit
      // it when blank rather than sending "".
  ...
  return (
    <div className="flex min-h-svh w-full bg-background">
      ...
      <div className="relative hidden w-1/2 lg:block">
        ...
        <img
          src="https://images.unsplash.com/photo-1542281286-9e0a16bb7366?w=1920&q=80"
        ...
        <div className="relative z-20 flex h-full flex-col justify-between p-12 text-white">
          ...
          <div className="max-w-md space-y-6">
            <h1 className="text-5xl leading-tight font-bold tracking-tighter">
              Build your <br />
              <span className="text-primary">Digital Garage.</span>
            </h1>
            <p className="text-lg text-white/70">
              Join thousands of professionals managing their automotive
              inventory with peak efficiency.
            </p>
